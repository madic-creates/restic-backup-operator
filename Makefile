...
IMG ?= ghcr.io/madic-creates/restic-backup-operator:latest
...
docker-buildx: ## Build and push docker image for cross-platform support.
	...
	$(CONTAINER_TOOL) buildx build --push --platform=linux/amd64 --tag ${IMG} .
...
helm-crds: manifests ## Generate CRDs as Helm templates (allows installation without --server-side).
	...
	@cat config/crd/bases/*.yaml >> charts/restic-backup-operator/templates/crds.yaml
